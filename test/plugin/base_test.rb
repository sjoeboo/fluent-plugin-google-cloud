...
module BaseTest
  ...
  def test_prometheus_metrics
    ...
    [
      ...
      setup_logging_stubs(code, 'Some Message') do
  ...
  def test_partial_success
    ...
    # the exception.
    setup_logging_stubs(partial_success_info[:error_code],
                        partial_success_info[:error_message],
                        partial_success_info[:error_metadata]) do
      d = create_driver(PROMETHEUS_ENABLE_CONFIG)
      4.times do |i|
        d.emit('message' => log_entry(i.to_s))
      end
